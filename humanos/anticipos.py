...
class funcion_abm:
    ...
    def __init__(self, edit, origen):
        ...
        self.obj("txt_04").set_max_length(12)
        self.obj("txt_05").set_max_length(100)

        self.obj("txt_00").set_tooltip_text("Ingrese el Código del Anticipo")
        self.obj("txt_01").set_tooltip_text(Mens.usar_boton("el Empleado cuyo Anticipo es registrado"))
        ...
        self.obj("txt_03").set_tooltip_text("Porcentaje del Salario Mensual pagado como Anticipo")
        self.obj("txt_04").set_tooltip_text("Ingrese el Monto a pagar como Anticipo")
        self.obj("txt_05").set_tooltip_text("Ingrese cualquier información adicional con respecto al Anticipo del Empleado")
    ...
    def on_txt_03_value_changed(self, objeto):
        porcentaje = round(Decimal(self.obj("txt_03").get_value()), 2)
        monto = Decimal(self.obj("txt_02_2").get_text()) * porcentaje / 100
        self.obj("txt_04").set_text(str(round(monto, 2)))
...
def config_grilla(self):
    ...
    col10.set_sort_column_id(18)  # Para ordenarse usa la fila 18
    ...
    col12.set_sort_column_id(19)  # Para ordenarse usa la fila 19
    ...
    lista = ListStore(int, int, int, str, str, str, str, int, str,
        int, str, float, str, str, str, str, str, str, str, str)
...
def columna_buscar(self, idcolumna):
    if idcolumna == 0:
        ...
        col, self.campo_buscar = "Monto de Anticipo", "Monto"
    elif idcolumna == 19:
