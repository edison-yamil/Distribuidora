...
class funcion_abm:
    ...
    def on_btn_guardar_clicked(self, objeto):
        ...
        sql = cod + ", " + cont + ", '" + self.fechaini + "', " + \
            "'" + self.fechafin + "', '" + exp + "', '" + self.fechaexp + "', " + obs
    ...
    def focus_in_event(self, objeto, evento):
        if objeto in (self.obj("txt_01"), self.obj("txt_01_2")):
            ...
            tipo = "la Fecha de expedición del Expediente o de la Resolución"
        elif objeto == self.obj("txt_05"):
            tipo = "la Fecha de Inicio del Reposo del Empleado"
        elif objeto == self.obj("txt_06"):
            tipo = "la Fecha de Finalización del Reposo del Empleado"
...
def config_grilla(self):
    ...
    col9.set_sort_column_id(19)  # Para ordenarse usa la fila 21
    col10 = Op.columnas("Fecha de Finalización", celda0, 10, True, 200)
    col10.set_sort_column_id(20)  # Para ordenarse usa la fila 22
    ...
    col13 = Op.columnas("Fecha de Expediente", celda0, 13, True, 200)
    col13.set_sort_column_id(21)  # Para ordenarse usa la fila 23
...
def cargar_grilla(self):
    ...
    cursor = Op.consultar(conexion, "idReposo, NroContrato, idEmpleado, " +
        "idTipoDocumento, NroDocumento, NombreApellido, FechaNacimiento, " +
        "Edad, Cargo, FechaInicio, FechaFin, CantDias, NroExpediente, " +
        "FechaExpediente, Observaciones, Alias, NroDocUsuario, NombreUsuario",
    ...
    for i in range(0, cant):
        ...
        fechaexp = "" if datos[i][13] is None else Cal.mysql_fecha(datos[i][13])
        ...
        lista.append([datos[i][0], datos[i][1], datos[i][2], datos[i][3],
            ...
            str(datos[i][6]), str(datos[i][9]), str(datos[i][10]), str(datos[i][13])])
