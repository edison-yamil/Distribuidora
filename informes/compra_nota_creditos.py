...
class informe_compra_nota_creditos:
    ...
    def __init__(self, datos):
        ...
        self.obj("ventana").set_title("Informes de Notas de Crédito por Compras")
    ...
    def on_btn_aceptar_clicked(self, objeto):
        ...
        informe_vista(self, "Notas de Crédito por Compras")
    ...
    def on_cmb_changed(self, objeto):
        ...
        if objeto == self.obj("cmb_prov_doc"):
            ...
            self.obj("label7").set_visible(estado)
...
##### Ventana de Vista Previa ##########################################
    ...
    def config_grilla(self, grilla):
        ...
        col3 = columnas("Nro. Doc. Prov.", celda0, 3, True, 100, 150)
        col3.set_sort_column_id(3)
        col4 = columnas("Proveedor", celda1, 4, True, 100, 250)
    ...
    def cargar_grilla(self, grilla, barraestado):
        ...
        # Obtener datos de Notas de Credito por Compras
        conexion = conectar(self.datos_conexion)
        cursor = consultar(conexion, "NroTimbrado, " +
            "NroNotaCredito, Fecha, NroDocProveedor, RazonSocial, Total",
            "notacreditocompras_s", " WHERE " + condicion)
    ...
    def preparar_pdf(self, grilla):
        ...
        if ubicacion_archivo is not None:
            ...
            if self.obj("chk_01").get_active():  # Proveedor
                story.append(Par("Notas de Crédito del Proveedor <b>" +
            ...
            lista = [[Par("Nro. Timbrado", head), Par("Nro. Nota de Crédito", head),
                Par("Fecha", head), Par("Nro. Doc. Prov.", head),
                Par("Proveedor", head), Par("Total", head)]]
