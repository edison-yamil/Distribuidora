...
class informe_compra_nota_debitos:

    def __init__(self, datos):
        self.datos_conexion = datos

        arch = archivo("informe_compra_nota_debitos")
        self.obj = arch.get_object

        self.obj("ventana").set_position(1)
        self.obj("ventana").set_title("Informes de Notas de Débito por Compras")
    ...
    def on_btn_aceptar_clicked(self, objeto):
        ...
        informe_vista(self, "Notas de Débito por Compras")
...
##### Ventana de Vista Previa ##########################################
    ...
    def cargar_grilla(self, grilla, barraestado):
        ...
        # Obtener datos de Notas de Debito por Compras
        conexion = conectar(self.datos_conexion)
        cursor = consultar(conexion, "NroTimbrado, " +
            "NroNotaDebito, Fecha, NroDocProveedor, RazonSocial, Total",
            "notadebitocompras_s", " WHERE " + condicion)
    ...
    def preparar_pdf(self, grilla):
        ...
        ubicacion_archivo = dialogo_guardar("Notas de Débito por Compras")
        ...
        if ubicacion_archivo is not None:
            ...
            story.append(Par("Notas de Débito por Compras", cabecera))
            story.append(Spacer(0, 20))

            if self.obj("chk_01").get_active():  # Proveedor
                story.append(Par("Notas de Débito del Proveedor <b>" +
            ...
            doc = SimpleDocTemplate(
                ...
                allowSplitting=1,
                title="Notas de Débito por Compras",
